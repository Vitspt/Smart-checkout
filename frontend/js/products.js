...
const DEFAULT_PRODUCTS = [
  ...
  { id:'1007', barcode:'1007', name:'Brown Bread', brand:'Harvest Gold', category:'Grocery', price:45, mrp:50, emoji:'🍞', stock:20, img:'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80', location:{ floor:'G', section:'Bakery', hall:'Main Hall', tab:'B01', row:'R02' } },
  ...
  { id:'2002', barcode:'2002', name:'Britannia Good Day', brand:'Britannia', category:'Snacks', price:35, mrp:40, emoji:'🍪', stock:120, img:'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=600&q=80', location:{ floor:'G', section:'Biscuits', hall:'East Wing', tab:'S04', row:'R02' } },
  ...
  { id:'2004', barcode:'2004', name:'Kurkure Masala Munch', brand:'PepsiCo', category:'Snacks', price:20, mrp:20, emoji:'🌽', stock:180, img:'https://images.unsplash.com/photo-1600271772470-bd22a42787b3?w=600&q=80', location:{ floor:'G', section:'Snack Zone', hall:'East Wing', tab:'S02', row:'R05' } },
  ...
  { id:'2007', barcode:'2007', name:'Maggi Masala Noodles', brand:'Nestle', category:'Snacks', price:14, mrp:14, emoji:'🍜', stock:200, img:'https://images.unsplash.com/photo-1612927601601-6638404737ce?w=600&q=80', location:{ floor:'G', section:'Instant Food', hall:'East Wing', tab:'S10', row:'R08' } },
  { id:'2008', barcode:'2008', name:'Act II Popcorn Butter', brand:'Act II', category:'Snacks', price:35, mrp:40, emoji:'🍿', stock:80, img:'https://images.unsplash.com/photo-1578916171728-46686eac8d58?w=600&q=80', location:{ floor:'G', section:'Snack Zone', hall:'East Wing', tab:'S03', row:'R07' } },
  { id:'3001', barcode:'3001', name:'Bisleri Mineral Water 1L', brand:'Bisleri', category:'Drinks', price:20, mrp:20, emoji:'💧', stock:300, img:'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=600&q=80', location:{ floor:'G', section:'Cold Storage', hall:'North Hall', tab:'D05', row:'R10' } },
  { id:'3002', barcode:'3002', name:'Tropicana Orange Juice', brand:'Tropicana', category:'Drinks', price:110, mrp:130, emoji:'🍊', stock:40, img:'https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=600&q=80', location:{ floor:'G', section:'Juices', hall:'North Hall', tab:'D06', row:'R02' } },
  ...
  { id:'3004', barcode:'3004', name:'Red Bull Energy Drink', brand:'Red Bull', category:'Drinks', price:125, mrp:125, emoji:'🐂', stock:60, img:'https://images.unsplash.com/photo-1553361371-9b22f78e8b1d?w=600&q=80', location:{ floor:'G', section:'Energy Drinks', hall:'North Hall', tab:'D09', row:'R01' } },
  ...
  { id:'3007', barcode:'3007', name:'Sprite 1.25L', brand:'Coca-Cola', category:'Drinks', price:65, mrp:70, emoji:'🍋', stock:100, img:'https://images.unsplash.com/photo-1581006852262-e4307cf6283a?w=600&q=80', location:{ floor:'G', section:'Cold Storage', hall:'North Hall', tab:'D08', row:'R06' } },
  ...
  { id:'4002', barcode:'4002', name:'Head & Shoulders', brand:'P&G', category:'Personal Care', price:149, mrp:175, emoji:'🧴', stock:75, img:'https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=600&q=80', location:{ floor:'1st', section:'Hair Care', hall:'West Hall', tab:'B04', row:'R08' } },
...
const DATA_VERSION = '1.0.4'; // Update this to force refresh
