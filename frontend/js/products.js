...
const DEFAULT_PRODUCTS = [
  ...
  { id:'5001', barcode:'5001', name:'Fresh Banana', brand:'Organic', category:'Produce', price:40, mrp:80, emoji:'🍌', stock:500, img:'https://images.unsplash.com/photo-1603833665858-e61d17a86224?w=600&q=80', location:{ floor:'G', section:'Fruits', hall:'Main Hall', tab:'F01', row:'R02' } },
  { id:'5002', barcode:'5002', name:'Red Onion', brand:'Organic', category:'Produce', price:35, mrp:70, emoji:'🧅', stock:400, img:'https://images.unsplash.com/photo-1508747703725-719777637510?w=600&q=80', location:{ floor:'G', section:'Vegetables', hall:'Main Hall', tab:'F03', row:'R04' } },
  { id:'5003', barcode:'5003', name:'Fresh Tomato', brand:'Organic', category:'Produce', price:25, mrp:50, emoji:'🍅', stock:350, img:'img/products/Fresh Tomato.jpeg', location:{ floor:'G', section:'Vegetables', hall:'Main Hall', tab:'F03', row:'R06' } },
  { id:'5004', barcode:'5004', name:'Fuji Apple', brand:'Imported', category:'Produce', price:180, mrp:360, emoji:'🍎', stock:150, img:'img/products/Fuji Apple.jpeg', location:{ floor:'G', section:'Fruits', hall:'Main Hall', tab:'F02', row:'R08' } },
  { id:'5005', barcode:'5005', name:'Sweet Mango (Kesar)', brand:'Organic', category:'Produce', price:80, mrp:160, emoji:'🥭', stock:200, img:'https://images.unsplash.com/photo-1553279768-865429fa0078?w=600&q=80', location:{ floor:'G', section:'Fruits', hall:'Main Hall', tab:'F01', row:'R04' } },
  { id:'5006', barcode:'5006', name:'Watermelon (Per Kg)', brand:'Organic', category:'Produce', price:15, mrp:30, emoji:'🍉', stock:100, img:'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=600&q=80', location:{ floor:'G', section:'Fruits', hall:'Main Hall', tab:'F02', row:'R10' } },
  { id:'5007', barcode:'5007', name:'Fresh Grapes (Green)', brand:'Organic', category:'Produce', price:60, mrp:120, emoji:'🍇', stock:180, img:'https://images.unsplash.com/photo-1537640538966-79f369143f8f?w=600&q=80', location:{ floor:'G', section:'Fruits', hall:'Main Hall', tab:'F01', row:'R06' } },
  { id:'5008', barcode:'5008', name:'Carrot (Per Kg)', brand:'Organic', category:'Produce', price:30, mrp:60, emoji:'🥕', stock:300, img:'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=600&q=80', location:{ floor:'G', section:'Vegetables', hall:'Main Hall', tab:'F03', row:'R08' } },
  { id:'6001', barcode:'6001', name:'Classmate Notebook', brand:'ITC', category:'Stationery', price:60, mrp:120, emoji:'📓', stock:100, img:'img/products/Classmate Notebook.jpg', location:{ floor:'1st', section:'Books', hall:'West Hall', tab:'W02', row:'R11' } },
  { id:'6002', barcode:'6002', name:'Parker Vector Ball Pen', brand:'Parker', category:'Stationery', price:125, mrp:250, emoji:'🖋️', stock:30, img:'img/products/Parker Vector Ball Pen.jpg', location:{ floor:'1st', section:'Writing', hall:'West Hall', tab:'W04', row:'R09' } },
  { id:'7001', barcode:'7001', name:"Lays Magic Masala 52g", brand:"Lay's", category:'Snacks', price:10, mrp:20, emoji:'🥔', stock:200, img:'img/products/lays.jpeg', location:{ floor:'G', section:'Snack Zone', hall:'East Wing', tab:'S02', row:'R09' } },
  { id:'7002', barcode:'7002', name:'Sunsilk Shampoo 400ml', brand:'Sunsilk', category:'Personal Care', price:99, mrp:198, emoji:'🧴', stock:60, img:'https://images.unsplash.com/photo-1585751119414-ef2636f8aede?w=600&q=80', location:{ floor:'1st', section:'Hair Care', hall:'West Hall', tab:'B04', row:'R12' } },
  { id:'7003', barcode:'7003', name:'Minute Maid Guava 1L', brand:'Coca-Cola', category:'Drinks', price:55, mrp:110, emoji:'🧃', stock:80, img:'https://images.unsplash.com/photo-1534353436294-0dbd4bdac845?w=600&q=80', location:{ floor:'G', section:'Juices', hall:'North Hall', tab:'D06', row:'R06' } },
  { id:'7004', barcode:'7004', name:'Amul Cheese Slices 200g', brand:'Amul', category:'Grocery', price:90, mrp:180, emoji:'🧀', stock:45, img:'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=600&q=80', location:{ floor:'G', section:'Dairy', hall:'North Hall', tab:'D02', row:'R07' } },
